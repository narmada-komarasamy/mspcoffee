...
import { nullableDateOrTime, requireEstateStaffMeetingUser, stringValue } from '../_auth';
...
export async function POST(request: Request) {
  ...
  const { error } = await auth.supabase.from('estate_staff_meeting_actions').insert([{
