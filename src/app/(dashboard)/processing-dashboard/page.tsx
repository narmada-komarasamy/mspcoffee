...
const SEASONS: SeasonData[] = [
  {
    label: '2025 – 2026',
    estates: [
      { name: 'Stanmore Estate',     code: 'SE · Yercaud',  icon: '🌿', href: '/processing-dashboard/stanmore-estate',     accent: '#1b5e20', batches: 246, ripeCherry: 118420, dryParchment: 31204, outturn: 26.4 },
      { name: 'Moganad Estate',      code: 'ME · Yercaud',  icon: '☕', href: '/processing-dashboard/moganad-estate',      accent: '#1a237e', batches: 407, ripeCherry: 204189, dryParchment: 51182, outturn: 28.3 },
      { name: 'Orchardale Estate',   code: 'OE · Yercaud',  icon: '🌱', href: '/processing-dashboard/orchardale-estate',   accent: '#4a148c', batches: 118, ripeCherry:  48310, dryParchment: 11820, outturn: 24.5 },
      { name: 'Bison Valley Estate', code: 'BVE · Yercaud', icon: '🦬', href: '/processing-dashboard/bve',                accent: '#e65100', batches:  79, ripeCherry:  29440, dryParchment:  7480, outturn: 25.4 },
